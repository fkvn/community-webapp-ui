...
export const IS_LOCATION_PUBLIC = "isLocationPublic";
...
export const PROFILE_BUSINESS_TYPE_PROP = "BUSINESS_PROFILE";
export const PROFILE_AVATAR_PROP = "avatarUrl";
...
export const IS_SIZE_PUBLIC_PROP = "isSizePublic";
...
export const SEARCH_FILTER_BUSINESS_FILED_LIST = [COMPANY_INDUSTRY_PROP];
export const SEARCH_FILTER_FIELD_LIST = [
	...
	...SEARCH_FILTER_BUSINESS_FILED_LIST,
	SEARCH_FILTER,
];
